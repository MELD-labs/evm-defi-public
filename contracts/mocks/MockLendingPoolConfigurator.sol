...
/**
 * @title MockLendingPoolConfigurator contract
 * @notice Implements the functions to create and configure LendingPool reserves
 * @author MELD team
 */
contract MockLendingPoolConfigurator is
    LendingBase,
    ...
    Initializable
{
    ...
    // Extra storage variable for upgradeability
     ...
     */
    function _initReserve(InitReserveInput calldata _input) internal {
     ...
     */
    function _createMToken(InitReserveInput calldata _input) internal returns (address) {
     ...
     */
    function _createStableDebtToken(InitReserveInput calldata _input) internal returns (address) {
     ...
     */
    function _createVariableDebtToken(InitReserveInput calldata _input) internal returns (address) {
     ...
     * @param _asset The address of the underlying asset of the reserve
     */
    function _checkNoLiquidity(address _asset) internal view {
