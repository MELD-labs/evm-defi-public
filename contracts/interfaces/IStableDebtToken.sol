...
/**
 * @title IStableDebtToken interface
 * @notice Interface for the MELD stable debt token
 * @author MELD team
 */
interface IStableDebtToken is IInitializableDebtToken {
    ...
    /**
     * @notice Returns the principal, the total supply and the average stable rate
     */
